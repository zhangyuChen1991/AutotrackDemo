...
public class LogHookConfig {
     ...
     * 日志采集埋点入口类
     */
    public static String LOG_ANALYTICS_BASE = "com/mmc/lamandys/liba_datapick/AutoTrackHelper"
//    public static String LOG_ANALYTICS_BASE = "com/demo/cc/autotrack/AutoTrackHelper"
